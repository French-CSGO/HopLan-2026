...
This does not confirm with 100% certainty that the event is "Ranked" and relies on data coverage by HLTV. Hoplan will apply for HLTV coverage under their specific guidelines no more than 15 days prior to the start of the "Main Event" stage.

Hoplan is not able to guarantee prior to the event if coverage is confirmed. We will follow due process to receive coverage as we have for all of our Counter-Strike LAN events since Hoplan.
...
Extends Signups Opening: 18:00 GMT+0 15/05/2026
